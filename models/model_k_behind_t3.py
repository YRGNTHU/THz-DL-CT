...
class THz_SR_net(nn.Module):
    def __init__(self, sp_k_size=3, t_k_size=3, out_ch_tconv1=64):
        ...
        block3 = nn.Sequential(
            nn.Conv2d(self.out_ch_tconv4,self.out_ch_tconv7,kernel_size=(self.sp_k_s,self.t_k_s),
                        stride=(1,1), padding=(int(self.sp_k_s//2),int(self.t_k_s//2))),
            nn.BatchNorm2d(self.out_ch_tconv7),
            nn.ReLU(),
            nn.Conv2d(self.out_ch_tconv7,self.out_ch_tconv7,kernel_size=(self.sp_k_s,self.t_k_s),
                        stride=(1,1), padding=(int(self.sp_k_s//2),int(self.t_k_s//2))),
            nn.BatchNorm2d(self.out_ch_tconv7),
            nn.ReLU(),
