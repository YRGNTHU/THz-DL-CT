...
class THz_SR_net(nn.Module):
    def __init__(self, sp_k_size=3, t_k_size=3, out_ch_tconv1=64):
        ...
        block4 = nn.Sequential(
            nn.Conv2d(self.out_ch_tconv7,self.out_ch_tconv11,kernel_size=(self.sp_k_s,self.t_k_s),
                        stride=(1,1), padding=(int(self.sp_k_s//2),int(self.t_k_s//2))),
            nn.BatchNorm2d(self.out_ch_tconv11),
            nn.ReLU(),
            nn.Conv2d(self.out_ch_tconv11,self.out_ch_tconv11,kernel_size=(self.sp_k_s,self.t_k_s),
                        stride=(1,1), padding=(int(self.sp_k_s//2),int(self.t_k_s//2))),
            nn.BatchNorm2d(self.out_ch_tconv11),
            nn.ReLU(),
        ...
        self.classification = nn.Sequential(
            ...
            nn.Conv2d(self.out_ch_tconv11,1,1),
            )
